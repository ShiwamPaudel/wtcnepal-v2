...
export const metadata: Metadata = constructMetadata({
  ...
  description:
    'Explore Web Trading Concern Pvt. Ltd. diagnostics solutions including IVD analyzers, laboratory equipment, point-of-care testing, reagents, training, and service support.',
