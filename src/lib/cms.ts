  ...
  'home-banners': [
    {
      ...
      alt: 'Web Trading Concern Pvt. Ltd. home banner',
      sortOrder: 0,
      published: true,
    },
  ],
  ...
  'about-page': [
    {
      ...
      directorMessage:
        'Web Trading Concern Pvt. Ltd. continues to grow with a service-first commitment: reliable products, responsive support, and long-term partnership with healthcare teams across the country.',
      directorImage: '',
